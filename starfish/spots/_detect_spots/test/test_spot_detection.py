...
from starfish.spots._detect_spots.local_max_peak_finder import LocalMaxPeakFinder
from starfish.spots._detect_spots.trackpy_local_max_peak_finder import TrackpyLocalMaxPeakFinder
