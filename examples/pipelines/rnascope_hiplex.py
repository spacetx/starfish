...
This notebook walks through a work flow that analyzes one field of view of _____ from
ACDBio, using the starfish package.

This example processes an experiment with a single round from a single field of view of RNAScope
HiPlex data taken from ____. These data

The data consist of 15 images from 3 round, 5 channels, and 1 z-plane. Each image is
(2048, 2048) (y, x).
"""
