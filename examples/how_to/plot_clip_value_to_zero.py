...
clipper = Filter.ClipValueToZero(v_min= 0.00003, v_max= 0.0015, levels= Levels.SCALE_BY_CHUNK)
#clip_ch1 = Filter.ClipValueToZero(v_min= 0.00006, v_max= 0.0035, levels= Levels.SCALE_BY_CHUNK)
#clip_ch2 = Filter.ClipValueToZero(v_min= 0.00006, v_max= 0.0035, levels= Levels.SCALE_BY_CHUNK)
clipper.run(stack, in_place=True)

plot_intensity_histograms(stack, r=1)