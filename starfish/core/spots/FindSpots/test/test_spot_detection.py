...
#     return BlobDetector(min_sigma=1, max_sigma=4, num_sigma=5, threshold=0,
...
#
#     # verify this execution strategy produces an empty intensitytable when called with a blank
# image
